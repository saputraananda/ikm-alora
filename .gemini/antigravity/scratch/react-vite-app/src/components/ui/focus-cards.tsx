...
export const Card = React.memo(
  ({
    ...
    >
      <div className="absolute inset-0 flex items-center justify-center text-gray-400 font-semibold italic">
         {card.title}
      </div>
      <div
        className={cn(
          "absolute inset-0 bg-black/50 flex items-end py-8 px-8 transition-opacity duration-300",
